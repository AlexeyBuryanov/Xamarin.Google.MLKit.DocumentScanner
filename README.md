# Document scanner with ML Kit on .NET for Android [![Nuget](https://img.shields.io/nuget/v/Net.Google.MLKit.DocumentScanner)](https://www.nuget.org/packages/Net.Google.MLKit.DocumentScanner)
