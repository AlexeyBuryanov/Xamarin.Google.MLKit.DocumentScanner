# Document scanner with ML Kit on .NET for Android [![Nuget](https://img.shields.io/nuget/v/Xamarin.Google.MLKit.DocumentScanner)](https://www.nuget.org/packages/Xamarin.Google.MLKit.DocumentScanner)
